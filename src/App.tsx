...
const phoneNumbers = [
  { label: "Gurugram Centre", number: "+91-8744002727" },
  { label: "Old Gurugram Centre", number: "+91-9971108920" },
  { label: "Manesar Centre", number: "+91-7291071742" }
];
  ...
  // Team data
  const team = [
    { name: "DR. INDRAJEET KUNDU", qualification: "MBBS, MD (Radio-Diagnosis) FMF (London, UK) certified", experience: "10+ years", image: "https://images.pexels.com/photos/5215024/pexels-photo-5215024.jpeg?auto=compress&cs=tinysrgb&w=300" },
  ...
  const faqs = [
    {
      ...
      answer: "You need to carry a government-issued photo ID (Aadhaar Card, Driving Licence, Voter ID, Passport, etc.) along with a prescription or referral slip from your obstetrician or registered medical practitioner."
    },
    {
      question: "What is Form F?",
      answer: "Form F, under the PCPNDT Act 1994, must be filled out and signed before every ultrasound scan during pregnancy. It is a legal requirement and helps ensure that prenatal sex determination, which is a punishable offense, is not conducted."
    },
    {
      question: "Is Ultrasound safe?",
      answer: "Yes, ultrasound is completely safe for both the mother and the baby. It uses sound waves, not radiation, and all our equipment complies with international safety standards."
    },
    {
      question: "How often should ultrasound be done during pregnancy?",
      answer: <ul>
        <li>Ultrasound scans should be done as advised by your obstetrician. A general schedule includes:</li>
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      {/* Hero Section */}
      <section id="home" className="relative h-[150vh] lg:h-screen overflow-hidden">
  {heroSlides.map((slide, index) => (
    ...
    >
      ...
      {/* Mobile Layout */}
      <div className="lg:hidden bg-gradient-to-br from-slate-100 via-blue-100 to-indigo-200 h-full flex flex-col">
        {/* Content Section */}
      ...
      <section id="services" className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 bg-pink-500 rounded-xl flex items-center justify-center mx-auto mb-4">
              <img className='h-9' src='IVP.png' ></img>
              </div>
            ...
            <div className="relative bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-800">Gurugram Centre</h3>
                  </div>
                </div>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-gray-700 text-sm">Address</p>
                      <p className="text-gray-600 text-sm">Power Supply Colony, Imt Manesar, Gurugram, Haryana 122051</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <Phone className="w-4 h-4 text-gray-500 mt-1 mr-3 flex-shrink-0" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <div className="text-slate-400 space-y-3">
          <div>
            <p className="text-white font-semibold mb-1">Address</p>
            <p className="text-sm leading-relaxed">Power Supply Colony, Imt Manesar, Gurugram, Haryana 122051</p>
          </div>
          <div>
            <p className="text-white font-semibold mb-1">Phone</p>
...
<div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-50">
  <div className="flex flex-col bg-white/40 backdrop-blur-md shadow-lg rounded-lg">
    {/* Phone Section */}
    <div className="relative">
      <button
        onClick={() => setShowPhoneOptions(!showPhoneOptions)}
        className="w-16 h-16 bg-white/40 hover:bg-white/60 backdrop-blur-md transition-colors duration-300 flex items-center justify-center group rounded-full"
      ...
      {showPhoneOptions && (
        <div className="absolute right-16 top-0 bg-white shadow-xl rounded-l-lg overflow-hidden min-w-64">
          {phoneNumbers.map((phone, index) => (
            <a
              key={index}
              href={`tel:${phone.number}`}
              className="block px-4 py-3 text-sm text-gray-700 hover:bg-teal-50 border-b border-gray-100 last:border-b-0 transition-colors duration-200"
            >
    ...
    {/* WhatsApp */}
    <a
      href="https://wa.me/918744002727"
      target="_blank"
      rel="noopener noreferrer"
      className="w-16 h-16 bg-teal-600 hover:bg-teal-700 transition-colors duration-300 flex items-center justify-center group border-t border-teal-500"
    >
      <svg 
        className="w-6 h-6 text-white transform group-hover:scale-110 transition-transform duration-300" 
        fill="currentColor" 
    ...
    {/* Email */}
    <a
      href="mailto:info@prathamdiagnostic.com"
      className="w-16 h-16 bg-teal-600 hover:bg-teal-700 transition-colors duration-300 flex items-center justify-center group border-t border-teal-500"
    >
      <svg 
        className="w-6 h-6 text-white transform group-hover:scale-110 transition-transform duration-300" 
    ...
    {/* Facebook */}
    <a
      href="https://facebook.com/prathamdiagnostic"
      target="_blank"
      rel="noopener noreferrer"
      className="w-16 h-16 bg-teal-600 hover:bg-teal-700 transition-colors duration-300 flex items-center justify-center group border-t border-teal-500"
    >
    ...
    <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-50">
      <div className="flex flex-col bg-teal-600 shadow-2xl">
        {/* Phone Section */}
        <div className="relative">
          <button
            onClick={() => setShowPhoneOptions(!showPhoneOptions)}
            className="w-16 h-16 bg-teal-600 hover:bg-teal-700 transition-colors duration-300 flex items-center justify-center group"
          >
            <svg 
              className="w-6 h-6 text-white transform group-hover:scale-110 transition-transform duration-300" 
              fill="currentColor" 
